...
const plans = [
  ...
  { 
    name: "Pro", 
    price: "$40/month", 
    features: ["50 Signatex Max usages", "500 Signatex Lite usages", "Full paper trading access", "Advanced charting tools", "Dedicated support"] 
  },
];
    ...
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100 font-sans p-8">
      <div className="max-w-6xl mx-auto bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan) => (
            <div key={plan.name} className="bg-white dark:bg-gray-700 p-6 rounded-lg shadow-xl border-t-4 border-blue-500">
              ...
              <ul className="list-disc list-inside space-y-3 text-gray-700 dark:text-gray-200">
                {plan.features.map((feature, index) => {
                  // FIX/ADDITION START: Use icons for AI usage features
              ...
              <button 
                className="mt-6 w-full py-2 px-4 bg-blue-500 text-white font-semibold rounded-lg shadow-md hover:bg-blue-600 transition duration-300"
