...
// Icon for general analysis or insights
export const AnalysisIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M16 20V4a2 2 0 0 0-2-2h-4a2 2 0 0 0-2 2v16"/>
        <rect x="2" y="10" width="6" height="12" rx="2"/>
        <rect x="16" y="10" width="6" height="12" rx="2"/>
    </svg>
);

// Icon specifically for recommendations or suggestions
export const RecommendationIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M7 10v12"/>
...
// Icon for screening or filtering
export const ScreenerIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M10 10l-6 6"/>
        <path d="M10 10l6-6"/>
...
// Icon for the general AI Assistant (chat)
...
export const SignatexFlowIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M12 3v2.355M16.364 4.636l-1.414 1.414M19 12h-2.355M16.364 19.364l-1.414-1.414M12 21v-2.355M7.636 19.364l1.414-1.414M5 12H2.645M7.636 4.636l1.414 1.414" />
...
export const LightbulbIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" title="" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const SignatexMaxIcon: React.FC<IconProps> = (props) => (
    <svg 
        {...props} 
        xmlns="http://www.w3.org/2000/svg" 
        title="Signatex Max"
        ...
        strokeLinejoin="round"
    >
        <path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 18.25l-6.18 3.25L7 14.14l-5-4.87 6.91-1.01L12 2z"/>
    </svg>
);

export const SignatexLiteIcon: React.FC<IconProps> = (props) => (
    <svg 
        {...props} 
        xmlns="http://www.w3.org/2000/svg" 
        tilte="Signatex Lite"
        ...
        strokeLinejoin="round"
    >
        <path d="M11 2L2 15h9l-1 7 11-13h-9l1-7z"/>
    </svg>
);
...
// Icon for Insider Trades (using a person with an arrow)
export const UserStarIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export const GoogleIcon: React.FC<IconProps> = ({ className }) => (
    <svg width="24px" height="24px" viewBox="-3 0 262 262" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="xMidYMid" fill="#000000" stroke="#000000" stroke-width="10.741999999999999" className={className}>
